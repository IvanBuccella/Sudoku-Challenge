package it.ivanbuccella.sudoku.interfaces;
 ...
 * sudoku game, if it is not already placed takes 1 point, if it is already
 * placed and it is rights takes
 * 0 point, in other case receive -1 point. The games is based on 9 x 9 matrix.
 * All users that play to a game are automatically informed when a users
 * increment its score, and when
...
public interface SudokuGame {
	 ...
	 * @return the integer score of the plaed number.
	 */
